...
path='/datadrive1/pre_processed_HM/files_action_mids_cropped_resized/'

X_train_filenames2=np.load('/datadrive/downloads/cocoapi-master/PythonAPI/openpose/tf-pose-estimation/data_configs_op/files_action_aligned_humans_coco.npy')
label33= np.load('/datadrive/downloads/cocoapi-master/PythonAPI/openpose/tf-pose-estimation/data_configs_op/action_aligned_humans_coco.npy')
