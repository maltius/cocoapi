...
label1= np.load('data_configs_aic/aic_pre_cropped_mids.npy')
file_name = np.load('data_configs_aic/files_aic_pre_cropped_mids.npy')
p_a='/mnt/sda1/downloads/cocoapi-master/PythonAPI/aic_persons_mids/'
