...
label1= np.load('/datadrive/downloads/cocoapi-master/PythonAPI/openpose/tf-pose-estimation/data_configs_op/table_pre_aligned_humans_coco.npy',allow_pickle=True)
file_name = np.load('/datadrive/downloads/cocoapi-master/PythonAPI/openpose/tf-pose-estimation/data_configs_op/files_table_pre_aligned_humans_coco.npy')
p_a='/mnt/sda1/downloads/cocoapi-master/PythonAPI/aligned_table_persons_mids/'
...
for i in range(tot_data):
    ...
    # if True:
        if c<10000000:
            ...
            temp_label_dic=label1[i]['human1']
...
# np.save('data_configs_aic/aic_mids_croped.npy',new_labels1)
# np.save('data_configs_aic/files_aic_mids_cropped.npy',np.array(new_file_name))  

# np.save('data_configs/mpii_croped.npy',new_labels1)
# np.save('data_configs/files_mpii_cropped.npy',np.array(new_file_name))  
        
np.save('/datadrive/downloads/cocoapi-master/PythonAPI/openpose/tf-pose-estimation/data_configs_op/table_aligned_humans_coco.npy',new_labels1)
np.save('/datadrive/downloads/cocoapi-master/PythonAPI/openpose/tf-pose-estimation/data_configs_op/files_table_aligned_humans_coco.npy',np.array(new_file_name))  
