...
path='/datadrive/pre_processed_HM/files_aic_17_cropped_resized/'

X_train_filenames2=np.load('data_configs_aic/files_aic_17_cropped_resized.npy')
label3= np.load('data_configs_aic/aic_17_croped_resized.npy')
